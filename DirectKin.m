...
if (Angle2 < 340) && (Angle2 > 100) 
    Angle2 = input('Please, put another angle less than 100° or upper than 340: ');
end

Angle3 = input('The third angle is?: ');
if (Angle3 < 250)
    Angle3 = input('Please, put another angle less than 250°: ');
end

Angle4 = input('And the fourth angle is: ');
if (Angle4 < 270) && (Angle4 > 90)
    Angle4 = input('Please, put another angle upper than 270° or less than 90°: ');
end
